...
public class TestQuizTime {
	...
	String filename = "/Users/leesunny/Downloads/EnglishQuizWords.txt";
	Quiz[] quizzes;

	public TestQuizTime() {
		try {
			quizzes = new Quiz[]{ new MathQuiz(), new EnglishQuiz(filename) };
		} catch (IOException e) {
			System.err.println("Error initializing quizzes: " + e.getMessage());
			// Initialize with just MathQuiz if EnglishQuiz fails
